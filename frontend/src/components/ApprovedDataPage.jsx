  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.log("🔍 Fetching requests for user:", loggedInRequesterAddress);

        // Fetch all request IDs for the user
        ...
        setApprovedRequests(requests); // Update state with fetched requests
        console.log("✅ Approved Requests:", requests);
      } catch (error) {
        console.error("❌ Error fetching requests:", error);
        props.notifyDanger(theme, "Failed to fetch approved requests");
      }
