...
const notifyInfo = (theme) =>
  toast.info("Connect To Sepolia Testnet", {
...
const notifyWarnTestNet = (theme) => {
  toastId = toast.warn("Connect To Sepolia Testnet", {
    position: "bottom-center",
    autoClose: false,
    hideProgressBar: false,
    closeOnClick: false,
...
const notifyTestNetSuccess = (theme) => {
  toast.update(toastId, {
    render: "Successfully Connected To Sepolia Testnet",
    type: "success",
    autoClose: 2000,
    closeOnClick: true,
    closeButton: true,
